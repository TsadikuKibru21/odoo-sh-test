...
class PosOrder(models.Model):
	...
	def _process_order(self, order, draft, existing_order):
		...
		if pos_order.config_id.create_mrp_order and not draft and existing_order:
			if not hasattr(pos_order, 'is_refund') or (hasattr(pos_order, 'is_refund') and not pos_order.is_refund):
